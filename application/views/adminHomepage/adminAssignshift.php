            ...
            <div class="flex space x-6 darkmode bg-gray-100 p-4 rounded-md shadow-md flex-1">
                ...
                <div>
                    ...
                    <input type="time" name="shift_start" id="shift_start"
                        class="darkmode_text block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        required>
                </div>
        ...
        <div class="right-section">
            ...
            <?php if ($notifications): ?>
                <form method="POST" action="<?= site_url('controllerAttendance/deleteAllNotifications') ?>">
                    <button type="submit" class="bg-red-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-red-700">
